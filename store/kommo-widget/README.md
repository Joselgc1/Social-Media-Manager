...
The widget version is currently `1.2.7`. Increment `widget.version` in `manifest.json` every time a new archive is uploaded so Kommo refreshes the widget files.
